...
try:  # detectron2 is optional; see svgnet/util/d2_compat.py
    from detectron2.utils.comm import get_world_size
except ImportError:
    from ..util.d2_compat import get_world_size
...
class SetCriterion(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        # dn_out is None for drawings with no foreground targets — there are no
        # denoising queries to compute a loss against, so skip that term.
